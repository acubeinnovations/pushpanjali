...
<div id="calendar-page">
    <div id="calendar-header" align="center">
        <?php if($dp){ ?>
        <div align="right" class="closeme"><a href="javascript:closeMe();">x</a></div>	
        <?php } ?>
        <form id="calendarform" name="calendarform" method="post" action="<?php echo($thispage);?>" style="margin: 0px;">
          <table width="99%" border="0" align="center" cellpadding="1" cellspacing="0">
            <tr>
              <td align="right"><select name="m" class="selectors" onchange="javascript:submitCalendar();">
              <?php
              ...
              <td><select name="y" class="selectors" onchange="javascript:submitCalendar();">
              <?php
              $thisyear = date('Y');
