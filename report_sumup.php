  ...
  <tr>
    ...
    <table width="838" border="0" align="right" cellpadding="0" cellspacing="0" style="border:1px solid #999999;">
        <tr>
          ...
          <td width="469" height="40" style="padding-left:8px;border-bottom:1px solid #999999;"><span class="style5">Particulars</span></td>
        ...
        <tr>
          ...
          <td height="30" class="style1" style="padding-left:8px;border-bottom:1px solid #999999;"><span class="style5">മുന്‍ മാസ നീക്കിയിരിപ്പ്</span></td>
		...
		if($row_r_view_summary['date']!="") { ?>
          <tr>
            <td width="129" height="0" align="center" class="style1"><?php echo echotomysql($row_r_view_summary['date']); 
				?></td>
            <td width="469" height="30" align="left" valign="middle" class="style1"><a href="varavu.php?date=<?php echo $row_r_view_summary['date']; ?>">വരവ് - വഴിപാടുകള്‍</a></td>
          ...
          <tr>
            ...
            <a href="chilavu.php?date=<?php echo $row_r_view_summary['date']; ?>">ചിലവ് - വൌച്ചറുകള്‍</a></td>
            ...
            <td width="125" height="15" align="right" valign="middle" class="style1" style="border-bottom:1px solid #999999;"><?php if($row_r_view_voucher['SUM(amount)']!="") { 
			$v_dr[]=$row_r_view_voucher['SUM(amount)'];
			echo $row_r_view_voucher['SUM(amount)'].'.00'; } else{ echo "0.00"; $v_dr[]=0;} ?>&nbsp;&nbsp;&nbsp;&nbsp;</td>
          </tr>
          <?php } else {?>
          <tr>
            <td height="30" rowspan="2" align="center"><?php echo date('d-m-Y'); ?></td>
          ...
          <tr>
            <td height="30" align="left" valign="middle" class="style1" style="padding-left:8px;; font-family: Arial, Helvetica, sans-serif;"><span class="style8">ചിലവ് - വൌച്ചറുകള്‍</span></td>
            <td height="15" align="right" valign="middle" class="style1">0.00&nbsp;&nbsp;&nbsp;&nbsp;</td>
            <td height="15" align="right" valign="middle" class="style1"><?php echo $v_dr[]="0.00"; ?>&nbsp;&nbsp;&nbsp;&nbsp;</td>
          ...
          <tr>
            ...
            <td height="40" class="style5 style9" style="padding-left:8px;border-bottom:1px solid #999999;">അകെ</td>
            <td height="40" align="right" valign="middle" class="style1" style="border-bottom:1px solid #999999;"><?php echo array_sum($v_cr); ?>.00&nbsp;&nbsp;&nbsp;&nbsp;</td>
            <td height="40" align="right" valign="middle" class="style1" style="border-bottom:1px solid #999999;"><?php echo array_sum($v_dr); ?>.00&nbsp;&nbsp;&nbsp;&nbsp;</td>
          </tr>
          <tr>
            <td width="129" height="40" align="center"><span class="style3"></span></td>
            <td height="40" class="style5" style="padding-left:8px;"><strong>Closing balance<?php $v_cr_amount=array_sum($v_cr)+$v_opn_cr;
			$v_dr_amount=array_sum($v_dr)+$v_opn_dr; $v_clsng_bal=$v_cr_amount-$v_dr_amount?></strong></td>
            <td height="40" align="right" valign="middle" class="style1">  <span class="style5"><strong><?php if($v_clsng_bal>0) { echo $v_clsng_bal.'.00'; } ?>&nbsp;&nbsp;&nbsp;</strong></span></td>
            <td height="40" align="right" valign="middle" class="style1"><strong><?php if($v_clsng_bal<0) { echo abs($v_clsng_bal).'.00'; } ?>&nbsp;&nbsp;&nbsp;&nbsp;</strong></td>
          </tr>
      </table>
