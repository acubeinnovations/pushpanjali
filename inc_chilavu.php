...
?>
<?php if ($totalRows_r_view_voucher > 0) { // Show if recordset not empty ?>
  <table width="838" border="0" align="center" cellpadding="0" cellspacing="0" style="border:1px solid #999999;">
    <tr>
    ...
    <?php do { ?>
      <tr class="style1">
        ...
        <td width="160" height="30"><?php $v_vou_hd_id=$row_r_view_voucher['purpose']; include('purpose.php'); echo $v_vou_head;?></td>
